...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    const handleOverlayClick = () => {
      ...
      topic.classList.remove("gx-open-topic");
      overlay.style.display = "none";
      overlay.style.opacity = "0";
    };
  ...
  return (
    <>
              ...
              <ul className="gx-sb-list">
                ...
                <li className="gx-sb-item">
                  ...
                  <ul className="dropdown-data">
                    ...
                    <li>
                      <Link
                        href="/content#file_SystemManage"
                        className="drop-down"
                      >
                        <i className="ri-record-circle-line"></i>
                        <p>System Settings</p>
                    ...
                    <li>
                      <Link
                        href="/content#file_ProfileManage"
                        className="drop-down"
                      >
                        <i className="ri-record-circle-line"></i>
                        <p>Profile Menu</p>
      ...
      <div className="gx-side-overlay"></div>
    </>
  );
};
